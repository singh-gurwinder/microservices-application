...
public class JwtUtil {
    ...
    public String generate(AuthRequest authRequest, String type) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("id", authRequest.getUsername());
        return doGenerateToken(claims, authRequest.getUsername(), type);
    }
